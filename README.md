...
The ALX-Holberton B&B sums up the implementation of our five months of studies at the ALX-Holberton School - the fullstack software engineering program. The goal of the project is to deploy a replica of the Airbnb Website using our server. The final version of this project will have:
